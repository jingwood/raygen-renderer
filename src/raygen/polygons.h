...
// same way CubeMesh does. radiusStart is the radius at z = -0.5 (back),
// radiusEnd is the radius at z = +0.5 (front). Either radius may be 0
// for a true cone tip; in that case the corresponding cap is omitted.
